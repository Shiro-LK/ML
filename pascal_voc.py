...
def combine_files(listFile, filename):
    ...
    with open(filename, 'w') as f:
        for data in final_data:
            f.write(data)
save_pascal_voc(path_folder='../../dataset/VOCdevkit/VOC2007train/Annotations/', tosave='VOC2007train_yolo.txt', path_img='/DeepLearning/dataset/VOCdevkit/VOC2007train/JPEGImages/', mode='train')       
save_pascal_voc(path_folder='../../dataset/VOCdevkit/VOC2007test/Annotations/', tosave='VOC2007test_yolo.txt', path_img='/DeepLearning/dataset/VOCdevkit/VOC2007test/JPEGImages/', mode='test')
combine_files(['VOC2007train_yolo.txt', 'VOC2007test_yolo.txt'], 'VOC2007.txt')