...
class YOLOv1():
    ...
    # training steps
    def train(self, filename, epoch=50, batch_size=1, optimizer='adam', path=''):
        ...
        self.model.compile(optimizer=optimizer, loss=self.loss_yolo)
...
#yolo = YOLOv1(input_shape=(448,448,3), model='mobilenet', grid_size=(7,7), bounding_boxes=2, number_classes=20)
#yolo.load_network('YOLOv1.hdf5')
#yolo.train(filename, path='../../', batch_size=1)
